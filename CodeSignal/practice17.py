...
# # Define the parameter grid to search with Ridge regression
# param_grid = {
#   'rr__alpha': [0.1, 1.0, 10.0],
#   'poly__degree': [2, 3, 4]
# }

# # Define the parameter grid to search with SVM
# param_grid = {
#     'svm__C': [0.1, 1.0, 10.0],
...
grid_search_top = GridSearchCV(estimator=pipeline_top, param_grid=param_grid, cv=cv, scoring='neg_mean_squared_error', n_jobs=-1)
